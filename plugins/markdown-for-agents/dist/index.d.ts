...
export declare const MarkdownForAgents: (opts?: AgentMarkdownOptions) => {
    name: string;
    emit(ctx: AgentMarkdownCtx, content: readonly AgentMarkdownContent[]): Promise<string[]>;
    partialEmit(): AsyncGenerator<string>;
};
